...
namespace KNARZhelper.MetadataCommon.DatabaseObjectTypes
{
    ...
    {
        /// <summary>
        /// Defines whether the field should be copied by default when copying values between games
        ...
        /// </summary>
        /// <remarks>
        /// If the value already exists in the game, it will not be added again, and the method will
        /// return <see langword="false"/>. For list types the value will be added to the list, in
        /// all other cases it replaces the current value in the game.
        /// </remarks>
        ...
        /// Whether to only copy the value if the field in the target game is empty.
        /// </param>
        /// <returns>
        /// <see langword="true"/> if the value was copied successfully; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        /// <returns>
        /// <see langword="true"/> if the value exists in the game; otherwise, <see langword="false"/>.
        /// </returns>
