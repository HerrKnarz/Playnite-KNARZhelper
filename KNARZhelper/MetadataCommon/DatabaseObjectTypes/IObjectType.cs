...
namespace KNARZhelper.MetadataCommon.DatabaseObjectTypes
{
    ...
    /// </summary>
    /// <remarks>
    /// This interface extends <see cref="IMetadataFieldType"/> and <see cref="IGameInfoType"/>,
    /// providing additional methods for working with database objects.
    /// </remarks>
    public interface IObjectType : IMetadataFieldType, IGameInfoType
    {
        ...
        /// <param name="id">ID of the database object.</param>
        /// <returns>
        /// <see langword="true"/> if the database object exists in the specified game; otherwise,
        /// <see langword="false"/>.
        /// </returns>
        ...
        /// <returns>
        /// <see langword="true"/> if the database object is in use; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        /// </summary>
        /// <param name="name">
        /// The name of the database object whose identifier is to be retrieved. Cannot be null or empty.
        /// </param>
        /// <returns>
        /// The unique identifier (GUID) of the database object if found; otherwise, an empty GUID.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// This method retrieves all database objects except those whose identifiers are included
        /// in <paramref name="itemsToIgnore"/>. The caller is responsible for ensuring that the
        /// provided set of identifiers is not null.
        /// </remarks>
        /// <param name="itemsToIgnore">
        /// A set of unique identifiers representing the database objects to exclude from the
        /// metadata loading process.
        /// </param>
        /// <returns>
        /// A list of <see cref="DatabaseObject"/> instances representing the loaded metadata. The
        /// list will be empty if no metadata is loaded.
        /// </returns>
        List<DatabaseObject> LoadAllMetadata(HashSet<Guid> itemsToIgnore);

        /// <summary>
        /// Loads metadata for the specified game, returning a list of database objects that
        /// represent the game's metadata.
        /// </summary>
        /// <param name="game">The game for which metadata is to be loaded. Cannot be <see langword="null"/>.</param>
        /// <param name="itemsToIgnore">
        /// An optional set of item identifiers to exclude from the results. If <see
        /// langword="null"/>, no items are excluded.
        /// </param>
        /// <returns>
        /// A list of <see cref="DatabaseObject"/> instances representing the metadata for the
        /// specified game. The list will be empty if no metadata is found.
        /// </returns>
        ...
        /// A value indicating whether to exclude hidden games from the list of games to check. <see
        /// langword="true"/> to ignore hidden games; otherwise, <see langword="false"/>.
        /// </param>
        /// <returns>
        /// A list of <see cref="DatabaseObject"/> instances representing unused metadata. The list
        /// will be empty if no unused metadata is found.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// This method is useful for checking name uniqueness when updating an existing object
        /// </remarks>
        ...
        /// <returns>
        /// <see langword="true"/> if the name exists and is associated with an identifier other
        /// than <paramref name="idToIgnore"/>; otherwise, <see langword="false"/>.
        /// </returns>
