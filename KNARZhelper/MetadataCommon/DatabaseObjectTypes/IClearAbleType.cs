...
namespace KNARZhelper.MetadataCommon.DatabaseObjectTypes
{
    ...
    public interface IClearAbleType
    {
        ...
        /// </summary>
        /// <param name="game">
        /// The game instance containing the field to empty. Cannot be <see langword="null"/>.
        /// </param>
        ...
        /// </summary>
        /// <param name="game">
        /// The game instance containing the field to check. Cannot be <see langword="null"/>.
        /// </param>
        /// <returns>
        /// <see langword="true"/> if the field in the specified game is empty; otherwise, <see langword="false"/>.
        /// </returns>
