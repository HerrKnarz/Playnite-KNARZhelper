...
namespace KNARZhelper.MetadataCommon.DatabaseObjectTypes
{
    ...
    /// <returns>
    /// <see langword="true"/> if the rename operation is allowed to proceed; otherwise, <see langword="false"/>.
    /// </returns>
    ...
    public interface IEditableObjectType : IObjectType, IValueType
    {
        ...
        /// <returns>
        /// A <see cref="Guid"/> representing the unique identifier of the newly added database object.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// This method does not throw an exception if the object with the specified identifier does
        /// not exist; instead, it returns <see langword="false"/>.
        /// </remarks>
        /// <param name="id">The unique identifier of the database object to remove.</param>
        /// <returns>
        /// <see langword="true"/> if the object was successfully removed; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// If any identifier in <paramref name="ids"/> does not correspond to an object in the
        /// game, the method will return <see langword="false"/> and no objects will be removed.
        /// </remarks>
        ...
        /// <returns>
        /// <see langword="true"/> if all specified objects were successfully removed; otherwise,
        /// <see langword="false"/>.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// If the object with the specified <paramref name="id"/> does not exist in the game, the
        /// method returns <see langword="false"/>.
        /// </remarks>
        /// <param name="game">
        /// The game instance from which the object will be removed. Cannot be <see langword="null"/>.
        /// </param>
        ...
        /// <summary>
        /// Removes the specified object, identified by its unique identifier, from all games in the
        /// provided list.
        /// </summary>
        /// <remarks>
        /// This method iterates through the provided list of games and removes the object with the
        /// specified identifier from each game. The returned collection can be used to determine
        /// which games were affected by the operation.
        /// </remarks>
        /// <param name="games">
        /// The list of games from which the object will be removed. Cannot be null.
        /// </param>
        /// <param name="id">The unique identifier of the object to remove.</param>
        /// <returns>
        /// An enumerable collection of game identifiers representing the games from which the
        /// object was successfully removed. If the object was not found in any game, the collection
        /// will be empty.
        /// </returns>
        IEnumerable<Guid> RemoveObjectFromGames(List<Game> games, Guid id);

        /// <summary>
        /// Replaces the specified database object in the provided list of games with a new object
        /// type and/or identifier.
        /// </summary>
        /// <param name="games">
        /// The list of games in which the object will be replaced. Cannot be null.
        /// </param>
        /// <param name="id">The unique identifier of the object to replace.</param>
        /// <param name="newType">
        /// The new object type to assign to the database object. If null, the type will not be changed.
        /// </param>
        /// <param name="newId">
        /// The new unique identifier to assign to the database object. If null, the ID will not be changed.
        /// </param>
        /// <returns>
        /// An enumerable collection of game identifiers representing the games in which the object
        /// was successfully replaced. If the object was not found in any game, the collection will
        /// be empty.
        /// </returns>
        ...
        /// <param name="name">
        /// The new name to assign to the database object. Cannot be null or empty.
        /// </param>
        ...
        /// <param name="oldName">
        /// The current name of the entity. This value is used to verify the entity's existing state.
        /// </param>
        /// <param name="newName">The new name to assign to the entity. Cannot be null or empty.</param>
        /// <returns>
        /// A <see cref="DbInteractionResult"/> indicating the outcome of the operation, including
